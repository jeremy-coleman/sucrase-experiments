...
var parser = require('./socket-parser');
var url = require('url');
...
Server.prototype.serveClient = function(v){
  ...
  if (v && !clientSource) {
    clientSource = read(path.resolve(__dirname, "socket.io.slim.js"), 'utf-8')
    //(resolvePath('socket.io-client/dist/socket.io.js'), 'utf-8');
    try {
      clientSourceMap = function(){} //read(resolvePath('socket.io-client/dist/socket.io.js.map'), 'utf-8');
    } catch(err) {
