import { css, IRawStyle, memoizeFunction, mergeStyleSets } from "@uifabric/styleguide"
import {
  FontSizes,
  getFocusStyle,
  getGlobalClassNames,
...
import { IButton, IButtonProps, IButtonStyles } from "./Button"
import { getBaseSplitButtonClassNames, ISplitButtonClassNames } from "./SplitButton"
...
export class BaseButton extends React.Component<IBaseButtonProps, IBaseButtonState> implements IButton {
  ...
  private _onKeyDown = (ev: React.KeyboardEvent<HTMLDivElement | HTMLAnchorElement | HTMLButtonElement>) => {
    ...
    //if (this.props.disabled && (ev.key === "Enter" || ev.key === "Space")) {
      ev.preventDefault()
      ev.stopPropagation()
  ...
  private _handleTouchAndPointerEvent() {
    ...
    if (this._lastTouchTimeoutId !== undefined) {
      window.clearTimeout(this._lastTouchTimeoutId)
      this._lastTouchTimeoutId = undefined
    }
    this._processingTouch = true

    this._lastTouchTimeoutId = window.setTimeout(() => {
