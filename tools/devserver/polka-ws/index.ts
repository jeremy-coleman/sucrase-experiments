...
import { addWsMethod, websocketUrl } from './helpers';
import * as ws from './ws';

export function withWebsocket(app, httpServer, options = {}) {
  ...
  /* Make our custom `.ws` method available directly on the Polka application. You should
