...
export const DEFAULT_DEBOUNCE_DURATION = 15
...
export const debounce = (func: Procedure, wait: number = DEFAULT_DEBOUNCE_DURATION, immediate: boolean = false) => {
...
function getResizerStyles(position) {
  ...
  return [styles.resizer, resizerStyle]
}
...
export interface DockProps {
  ...
  size?: number
  defaultSize?: number
  dimMode?: "none" | "transparent" | "opaque" | string
  isVisible?: boolean
  onVisibleChange?: any
  onSizeChange?: any
  dimStyle?: object
...
class Dock extends React.Component<DockProps, any> {
  constructor(props) {
    super(props)
    this.state = {
...
export { Dock, Dock as Panel, DockProps as IPanelProps }
export default Dock
