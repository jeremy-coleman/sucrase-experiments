...
import { Callout, ICalloutContentStyleProps, ICalloutContentStyles, ICalloutProps, Target } from "./Callout"
...
import { getIsChecked, hasSubmenu, isItemDisabled } from "./contextualMenuUtility"
import { FocusZone, FocusZoneDirection, FocusZoneTabbableElements, IFocusZoneProps } from "./FocusZone"
...
export const getContextualMenuStyles = (props: IContextualMenuStyleProps): IContextualMenuStyles => {
...
export class ContextualMenuBase extends React.Component<IContextualMenuProps, IContextualMenuState> {
  ...
  public render(): JSX.Element | null {
    ...
    this._classNames = getMenuClassNames
      ...
      : classNamesFunction<IContextualMenuStyleProps, IContextualMenuStyles>()(styles, {
          theme: theme!,
          className: className
        })
    ...
    //this is not really implemented, it's (future?) purpose is to disable all beaks if screen size is medium or less
    isBeakVisible = isBeakVisible === undefined ? this.props.responsiveMode! <= 1 /**ResponsiveMode.medium*/ : isBeakVisible
  ...
  private _renderMenuItem(
    ...
    if (getItemClassNames) {
      ...
      itemClassNames = mergeStyleSets(
        classNamesFunction<IContextualMenuItemStyleProps, IContextualMenuItemStyles>()(getItemStyles, itemStyleProps),
        classNamesFunction<IContextualMenuItemStyleProps, IContextualMenuItemStyles>()(menuItemStyles, itemStyleProps),
        classNamesFunction<IContextualMenuItemStyleProps, IContextualMenuItemStyles>()(styles, itemStyleProps)
      )
    }
...
>(ContextualMenuBase, getContextualMenuStyles, undefined, { scope: "ContextualMenu" })
...
export interface IContextualMenuProps extends IBaseProps<IContextualMenu> {
  responsiveMode?: any
  /**
