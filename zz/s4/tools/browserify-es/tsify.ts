...
class Tsifier extends EventEmitter {
	...
	checkSyntax = function (program: ts.Program) {
		var self = this;
	...
	checkSemantics = function (program: ts.Program) {
		var self = this;
	...
	checkEmittedOutput = function (emitOutput: ts.EmitResult) {
		var self = this;
...
function tsify(b, opts) {
	...
	function gatherEntryPoints() {
		...
		function flush(next) {
			var self = this;
			var ignoredFiles = [];
			var entryFiles = rows.map(function (row) {
