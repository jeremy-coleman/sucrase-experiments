...
var {parse} = require('acorn-node');
var path = require('path');
var acorn = require('acorn-node')
var assert = require('assert')
const {through} = require('./streams');
...
module.exports.undeclaredIdentifiers = undeclaredIdentifiers
...
module.exports.insertModuleGlobals = insertModuleGlobals