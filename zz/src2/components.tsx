...
export const BottomToolbar = (props) => {
  return <div className='toolbar toolbar-bottom'>
                <button id={CLEAR_BUTTON_ID} className='toolbar-button'><i className="fa fa-remove"></i>&nbsp;&nbsp;Clear</button>
                <button id={NEW_BUTTON_ID} className='toolbar-button'><i className="fa fa-plus-circle"></i>&nbsp;&nbsp;New circlez</button>
...
export const Logo = (props) => {
  return <div className='flex-parent-centered transparent-for-clicks'>
                <div className='logo'>
...
export const TextRotator = () => {
    return <span className='top-left-instructions'>{texts.map(t => <p key={t}>{t}</p>)}</span>
}
