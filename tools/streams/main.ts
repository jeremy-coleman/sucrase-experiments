...
export {
  from2, fromString,
mergeStreams, concat, combiner, SinkStream, Splicer as StreamSplicer, duplex2, StreamCombiner, ReadOnlyStream, ConcatStream, through, Labeled as LabeledStreamSplicer,
  //aliases
  Labeled as splicer, ReadOnlyStream as readonly, duplex2 as duplexer, StreamCombiner as combine
};
