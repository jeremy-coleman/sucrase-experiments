...
import { HighContrastSelector, getGlobalClassNames } from '@uifabric/styleguide';
import { IsFocusVisibleClassName } from '@uifabric/styleguide';
...
export const getCheckboxStyles = (props: ICheckboxStyleProps): ICheckboxStyles => {
