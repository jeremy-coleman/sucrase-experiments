import { concatStyleSets, memoizeFunction, mergeStyles } from "@uifabric/styleguide"
import { getFocusStyle, ITheme } from "@uifabric/styleguide"
...
export const getBaseSplitButtonClassNames = memoizeFunction(
...
export const getSplitButtonStyles = memoizeFunction(
