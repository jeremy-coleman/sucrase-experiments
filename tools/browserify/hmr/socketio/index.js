...
var clientVersion = "dev" //require('socket.io-client/package.json').version;
var Client = require('./client');
var Emitter = require('events').EventEmitter;
var Namespace = require('./namespace');
var ParentNamespace = require('./parent-namespace');
var Adapter = require('./socket-adapter');
...
Server.prototype.serveClient = function(v){
  ...
  if (v && !clientSource) {
    clientSource = read(path.join(__dirname, "socket.io.slim.js"), 'utf-8')
